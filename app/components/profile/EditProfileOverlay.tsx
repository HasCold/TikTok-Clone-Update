...
let {setIsEditProfileOpen, user, token} = useGeneralStore();
...
const getUploadedImage = (e: React.ChangeEvent<HTMLInputElement>) => {
    const selectedFiles = e.target.files && e.target.files[0]; 
...
const showError = (type: string) => {  // type represent the type error whether it is email, password or name
...
const cropAndUpdateImage = async () => {
    ...
    try {
        ...
        console.warn(error);
        toast.error("Could not updated image!")
        setIsUpdating(false);
    }
}
        ...
        {!uploadedImage ? (
            <div>
                ...
                <div className='flex items-center justify-center sm:-mt-6'>
                    <label htmlFor="image" className='relative cursor-pointter'>
                    <img className='rounded-full cursor-cell' width="95" src={userImage} />
            ...
            >
                ...
                <div className='flex items-center justify-center sm:-mt-6'>
                    ...
                    onUpdate={setUserName}  // pushed out on this component
                    inputType="text"
